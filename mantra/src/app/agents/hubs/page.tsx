...
import { BookOpen, Plus, Users, Globe, Lock, Search, Loader2, X, Brain, ArrowRight, Star, FolderKanban, LayoutGrid, Calendar, BarChart2, MessageCircle } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-20">
        <div className="flex items-center gap-1 mb-8 overflow-x-auto no-scrollbar pb-1">
          {NAV_ITEMS.map(item => {
            ...
            const active = item.href === "/agents/hubs";
            return (
